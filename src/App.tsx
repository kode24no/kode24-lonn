...
import { tidy, arrange, fixedOrder } from "@tidyjs/tidy";
...
import {
  generateMunicipalitySalaryChart,
  generateSalaryAgeChart,
  SalaryData,
} from "./lib/charts";
        ...
        <section>
          ...
          <div className="charts-row">
            ...
            <div className="contribute">
              ...
              <p>
                Har du lyst til å bidra? Målet er å gjøre dette til et
                felleskapsprosjekt for kode24 sine lesere. Hvor folk kan lære om
                visualiseringer og bidra til noe som alle utviklere har nytte
                av.
              </p>
              <a
                className="github-link"
                href="https://github.com/MaximilianLloyd/kode24-lonn"
              >
